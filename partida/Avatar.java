    ...
    public void moverAvatar(ArrayList<ArrayList<Casilla>> tablero, int valorTirada,Menu menu){
        switch (this.avanzado) {
            ...
            case 1:
                ...
                if(tipo.equals("pelota")){
                    ...
                    if(valorTirada>4){
                        ...
                        lugar.anhadirAvatar(this);
                        //A partir de ahora nos movemos solo 1 y evaluamos la casilla a la que avanzamos SI ES UN INDICE IMPAR
            ...
            case 0:
                ...
                int nuevaPosicion3 = (posicionActual + valorTirada) % 40; // Usar el módulo para asegurarte de que vuelva al inicio si excede 39
                lugar.eliminarAvatar(this);
